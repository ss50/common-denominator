...
$(document).ready(function(){
	...
	if ($(window).scrollTop()>50){
		$('#denominatorHead').css("color", "white");
	}
	$('#profile-picture').click(function(){
			console.log($(window).scrollTop());
	});
	$('#contact-li').one("click",function(){
		$('#footer-p').append('<p id="email_us">Email us at firstName_lastName@brown.edu</p>');
	});
});
...
function getUsers(numusers){
	...
	myimages[4]="http://ethenrichardson.com/wp-content/uploads/2013/08/Ethen-square-profile.jpg";
	myimages[5]="http://images.coplusk.net/users/130710/avatar/large_square_profile.jpg";
	myimages[6]="http://burrilldigitalhealth.com/wp-content/uploads/bw_square_profile_picture_1800x1800_medium_res.jpeg";
	myimages[7]="http://greatist.com/sites/default/files/styles/square_profile/public/Profile%20Pic%20Square.jpg?itok=3q_N78z9";
	myimages[8]="http://image3.redbull.com/rbcom/010/2012-07-08/1331574883509_1/0010/1/1500/1500/1/nasser-al-attiyah-profile-square.jpg";
	myimages[9]="https://pbs.twimg.com/profile_images/2190908500/SamBillen_square-profile-pic.gif";
